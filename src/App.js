            ...
            <Container fluid  className="container">
              ...
              {modal===true && 
                <React.Fragment>
                  ...
                  <div style={{position: 'fixed',left: '50%',top: '50%',borderRadius: '5px',transform:'translate(-50%,-50%)',padding: '10px',textAlign: 'center',zIndex: 3, backgroundColor: 'white', width:'50%',height: 'auto'}}>
                    <FontAwesomeIcon icon={faExclamation} style={{fontSize:'50', margin:'3% 0'}}/>
                    <div style={{width:'100%',margin:'2%'}}>{errors}</div>
                    <div>
